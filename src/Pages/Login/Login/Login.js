...
const Login = () => {
    ...
    return (
        <div>
            ...
            <p className='text-center'>Did you forget your password? <Link to='/register' className='text-danger text-decoration-none pe-auto' onClick={resetPassword}>Reset Password</Link></p>
            {errorMessage}
